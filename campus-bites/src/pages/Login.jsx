        ...
        onSuccess: async (tokenResponse) => {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    // Navigation handled by useEffect in parent
                } else {
            ...
            <div className="glass-card" style={{
                ...
                {!showOtp ? (
                    <form onSubmit={handleSubmit}>
                        ...
                        <PrimaryButton type="submit" loading={loading} icon={ArrowRight} className="animate-item delay-8">
                            Sign In
                        </PrimaryButton>
                    </form>
                ) : (
                ...
                {/* Google Button (only if clientId configured) */}
                {hasGoogleClientId && (
